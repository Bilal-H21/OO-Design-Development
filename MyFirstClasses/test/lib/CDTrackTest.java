...
public class CDTrackTest {
	...
	public void testCustomConstructor() {
		var cd = new CDTrack_lib("We Are the Champions", "Queen", 218);
	...
	public void testCustomConstructorNegativeDuration() {
		var cd = new CDTrack_lib("We Are the Champions", "Queen", -5);
	...
	public void testToString() {
		var cd = new CDTrack("We Are the Champions", "Queen", 218);
